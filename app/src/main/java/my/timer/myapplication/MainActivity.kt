package my.timer.myapplication
...
import my.timer.myapplication.ui.theme.MyApplicationTheme
...
fun MainScreen(){
    ...
    Box {
        ...
        Box(
            modifier = Modifier.padding(20.dp).width(parentBoxWidth).
            height(childBoxSides).swipeable(
        ...
        Box(
            ...
            Modifier.offset{
                IntOffset(swipeableState.offset.value.roundToInt(),0) }.size(childBoxSides)
